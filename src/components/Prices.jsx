...
function Prices() {
  return (
    <div className="relative isolate bg-gray-100 dark:bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 transition-colors duration-300">
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              ...
              'rounded-3xl p-8 ring-1 ring-white/10 sm:p-10 transition-colors duration-300',
            )}
          >
            <h3
              id={tier.id}
            ...
            <ul
              role="list"
              className={classNames(
                tier.featured ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300',
